...
public class ComplexityMenuController {
    ...
    @FXML
    public void onNormalGamePressed() throws IOException {
        loadUnderConstructionScene();
    }

    private void loadUnderConstructionScene() throws IOException{
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../underConstruction/underConstructionScene.fxml"));
        Parent root = (Parent) loader.load();
        Stage stage= new Stage();
        stage.setTitle("BOMBERMEN");
        stage.initStyle(StageStyle.TRANSPARENT);
    ...
    @FXML
    public void onHardGamePressed() throws IOException {
        loadUnderConstructionScene();
    }
